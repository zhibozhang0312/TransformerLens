...
class Qwen3ArchitectureAdapter(ArchitectureAdapter):
    ...
    def __init__(self, user_cfg: Any) -> None:
        ...
        n_kv_heads = (
            self.user_cfg.n_key_value_heads
            if self.user_cfg.n_key_value_heads is not None
            else self.user_cfg.n_heads
        )
        ...
        self.conversion_rules = WeightConversionSet(
            {
                ...
                "blocks.{i}.attn.W_Q": (
                    ...
                    RearrangeWeightConversion("(n h) m -> n m h", n=self.user_cfg.n_heads),
                ),
                "blocks.{i}.attn.W_K": (
                    "model.layers.{i}.self_attn.k_proj.weight",
                    RearrangeWeightConversion("(n h) m -> n m h", n=n_kv_heads),
                ),
                "blocks.{i}.attn.W_V": (
                    "model.layers.{i}.self_attn.v_proj.weight",
                    RearrangeWeightConversion("(n h) m -> n m h", n=n_kv_heads),
                ),
                "blocks.{i}.attn.q_norm.w": "model.layers.{i}.self_attn.q_norm.weight",
                "blocks.{i}.attn.k_norm.w": "model.layers.{i}.self_attn.k_norm.weight",
                "blocks.{i}.attn.W_O": (
                    "model.layers.{i}.self_attn.o_proj.weight",
                    RearrangeWeightConversion("m (n h) -> n h m", n=self.user_cfg.n_heads),
                ),
